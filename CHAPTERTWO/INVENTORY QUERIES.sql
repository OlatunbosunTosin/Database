...
-- COUNT is used for counting the number of rows in a column while sum calculates total of values in a column-- 
...
-- where was applied first because it was on a single row but having was on an aggregate  value--  